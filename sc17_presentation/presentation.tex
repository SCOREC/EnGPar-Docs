...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth,height = 1.6in]{figures/PartBoundary.png}
  \end{figure}
\end{frame}
\begin{frame}
  \frametitle{Diffusive Terminology}
...
\begin{frame}
  \frametitle{Traversal Queue}
  This ordering becomes more difficult to compute when any part may be disconnected into multiple components. \\
  \smallskip
  ...
  \begin{figure}
    \centering
    \includegraphics[width=.5\textwidth]{figures/Disconnected.png}
  \end{figure}
  \vspace{-.5cm}
  The traversal queue for this part would be C,B,D,A.
\end{frame}
...
\begin{frame}
  ...
  \medskip
  ParMA and EnGPar are set to balance a mesh for a standard finite element analysis where:
  \begin{itemize}
