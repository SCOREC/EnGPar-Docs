...
\begin{textblock}{15.6}(0.2,4)
  ...
  \begin{textblock}{5}(10.6,0)
    ...
    \begin{block}{FUN3D: Fluid dynamics simulations}
      ...
      The ghost layer required can be treated similarly by accounting for the weight in the diffusive iterations (supply reference for previous work on ghost balancing). Furhtermore the overset grid can be accounted for in a similar way as listed above.
