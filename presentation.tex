...
\begin{frame}
  ...
  Our current N-Graph data structure is a two-level compressed sparse row (CSR):
  \begin{itemize}
    \item vertex ids are implicitly stored/referenced as indexes into/of the following
      arrays
    \item \textit{degree\_list} - vertex-to-net offsets
    \item \textit{edge\_list} - vertex-to-net adjacencies
    \item net ids are implicitly stored/referenced as indexes into/of the following
      arrays
    \item \textit{pin\_degree\_list} - net-to-vertex offsets
    \item \textit{pin\_list} - net-to-vertex adjacencies
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{table}[]
    ...
    \begin{tabular}{l|l|l|l|l|l|l|l|l}
      ...
      vtx-to-net offsets     & 0 & 1 & 4 & 5 & 6 &   \\
      vtx-to-net adjacencies & a &   a & b & c &  2 & 2 \\
      net id                 & a & b & c & d & e & f \\
      net-to-vtx offsets     & 0 & 2 & 6 &   &   &   \\
      net-to-vtx adjacencies & a & b & a & b & c & d
    \end{tabular}
  \end{table} 
  }
\end{frame}
