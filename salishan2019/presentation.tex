...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      {\tiny [2] M. Kreutzer, SISC 2014; Besta and Marending, IPDPS 2017}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=.6\textwidth]{figures/sellCSigma.png}\\
        \small{Sell-C-$\sigma$ data structure [2].} \smallskip \\
...
\begin{frame}
  ...
  \begin{itemize}
  \item Define units of work as the graph vertices with optional weights.
